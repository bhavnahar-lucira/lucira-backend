...
// Seed value only — the diamond bracelet is now one entry in the staff-configurable
// tiers list (settings doc key 'silver_bracelet_offer'), not a hardcoded identity
// check. Kept exported so settings.js can default a fresh doc to today's live offer.
...
function isFreeGiftVariant(variantId = "", extraVariantIds = []) {
  return isGoldCoinVariant(variantId) || extraVariantIds.includes(variantId);
}
      ...
      const tiers = rawTiers ?? [
        {
          ...
          enabled: true,
          min: Number(settings?.threshold) || 30000,
          giftVariantId: SILVER_BRACELET_VARIANT_ID,
          giftProductId: "gid://shopify/Product/9438188896474",
          giftTitle: "Diamond Bracelet",
          giftWorthValue: 15000,
          giftImage: "https://cdn.shopify.com/s/files/1/0739/8516/3482/files/Bracelet_PNG_1.png",
        },
      ];
      return {
